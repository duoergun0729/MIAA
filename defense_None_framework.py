...
if args.l2:
    npzdata=np.load(result_folder+"/models/"+"epoch_{}_weights_user_L2_{}.npz".format(user_epochs,float(args.e)))
elif args.dropout:
    npzdata=np.load(result_folder+"/models/"+"epoch_{}_weights_user_dropout_{}.npz".format(user_epochs,float(args.e)))
else:
...
#result_array=np.zeros(f_evaluate.shape,dtype=np.float)
#result_array_logits=np.zeros(f_evaluate.shape,dtype=np.float)
result_array=f_evaluate
result_array_logits=f_evaluate.shape
...
if args.l2:
    np.savez(result_folder+"/attack/"+"L2_{}_noise_data_{}.npz".format(args.e,args.qt),defense_output=result_array,defense_output_logits=result_array_logits,tc_output=f_evaluate_origin,tc_output_logits=f_evaluate_logits_origin,predict_origin=predict_origin,predict_modified=predict_modified)
elif args.dropout:
    np.savez(result_folder+"/attack/"+"dropout_{}_noise_data_{}.npz".format(args.e,args.qt),defense_output=result_array,defense_output_logits=result_array_logits,tc_output=f_evaluate_origin,tc_output_logits=f_evaluate_logits_origin,predict_origin=predict_origin,predict_modified=predict_modified)    
else:
    np.savez(result_folder+"/attack/"+"None_noise_data_{}.npz".format(args.qt),defense_output=result_array,defense_output_logits=result_array_logits,tc_output=f_evaluate_origin,tc_output_logits=f_evaluate_logits_origin,predict_origin=predict_origin,predict_modified=predict_modified)
